...
export default function UniqueUser({ params }: {
  params: {
    userID: string
  }
}) {
  ...
  useEffect(() => {
    axios.get((`http://127.0.0.1:8000/users/${params.userID}`), {
                  ...
                  <div className="static">
                    <Formik
                      ...
                      onSubmit={async (values) => {
                        console.log(values);
                        axios.put(`http://127.0.0.1:8000/users/${params.userID}`, {
                          data: {
                    ...
                    <Formik
                      ...
                      onSubmit={() => {
                        ...
                        axios.delete(`http://127.0.0.1:8000/users/${params.userID}`, {
                          withCredentials: true,
                        })
                          .then(response => {
                            if (response.status === 200) {
